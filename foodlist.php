...
<?php
  ...
  ?>
           <ul class="nav navbar-nav navbar-right">
            ...
            <li class="active" ><a href="foodlist.php"><span class="glyphicon glyphicon-cutlery"></span>Salad Zone </a></li>
